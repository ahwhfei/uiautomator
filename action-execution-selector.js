...
const PageOpsSelector = require('./page-ops-selector');

const timeout = config.timeout * 1000;

class ActionExecutionSelector {
    ...
    async run (actionList) {
        ...
        const pageOps = new PageOpsSelector(page);
...
module.exports = ActionExecutionSelector;
